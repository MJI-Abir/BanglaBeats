...
import 'package:banglabeats/presentation/splash_screen/splash_screen.dart';
import 'package:banglabeats/presentation/walkthrough_screen/walkthrough_screen.dart';
import 'package:banglabeats/presentation/lets_you_in_screen/lets_you_in_screen.dart';
import 'package:banglabeats/presentation/sign_in_screen/sign_in_screen.dart';
import 'package:banglabeats/presentation/sign_up_screen/sign_up_screen.dart';
import 'package:banglabeats/presentation/profile_screen/profile_screen.dart';
import 'package:banglabeats/presentation/create_new_pin_screen/create_new_pin_screen.dart';
import 'package:banglabeats/presentation/set_fingerprint_screen/set_fingerprint_screen.dart';
import 'package:banglabeats/presentation/follow_artists_screen/follow_artists_screen.dart';
import 'package:banglabeats/presentation/forgot_password_screen/forgot_password_screen.dart';
import 'package:banglabeats/presentation/filled_otp_screen/filled_otp_screen.dart';
import 'package:banglabeats/presentation/create_new_password_screen/create_new_password_screen.dart';
import 'package:banglabeats/presentation/home_container_screen/home_container_screen.dart';
import 'package:banglabeats/presentation/podcasts_notifications_tab_container_screen/podcasts_notifications_tab_container_screen.dart';
import 'package:banglabeats/presentation/trending_now_screen/trending_now_screen.dart';
import 'package:banglabeats/presentation/popular_artists_screen/popular_artists_screen.dart';
import 'package:banglabeats/presentation/charts_screen/charts_screen.dart';
import 'package:banglabeats/presentation/top_albums_global_screen/top_albums_global_screen.dart';
import 'package:banglabeats/presentation/podcasts_screen/podcasts_screen.dart';
import 'package:banglabeats/presentation/new_releases_screen/new_releases_screen.dart';
import 'package:banglabeats/presentation/search_type_keyword_screen/search_type_keyword_screen.dart';
import 'package:banglabeats/presentation/song_play_screen/song_play_screen.dart';
import 'package:banglabeats/presentation/song_details_screen/song_details_screen.dart';
import 'package:banglabeats/presentation/lyrics_screen/lyrics_screen.dart';
import 'package:banglabeats/presentation/artist_details_screen/artist_details_screen.dart';
import 'package:banglabeats/presentation/album_details_screen/album_details_screen.dart';
import 'package:banglabeats/presentation/podcast_details_screen/podcast_details_screen.dart';
import 'package:banglabeats/presentation/podcast_episode_details_screen/podcast_episode_details_screen.dart';
import 'package:banglabeats/presentation/playlist_details_one_screen/playlist_details_one_screen.dart';
import 'package:banglabeats/presentation/search_result_profile_tab_container_screen/search_result_profile_tab_container_screen.dart';
import 'package:banglabeats/presentation/profile_details_screen/profile_details_screen.dart';
import 'package:banglabeats/presentation/followers_details_tab_container_screen/followers_details_tab_container_screen.dart';
import 'package:banglabeats/presentation/history_podcast_tab_container_screen/history_podcast_tab_container_screen.dart';
import 'package:banglabeats/presentation/playlists_screen/playlists_screen.dart';
import 'package:banglabeats/presentation/playlist_details_screen/playlist_details_screen.dart';
import 'package:banglabeats/presentation/downloads_screen/downloads_screen.dart';
import 'package:banglabeats/presentation/queue_tab_container_screen/queue_tab_container_screen.dart';
import 'package:banglabeats/presentation/albums_screen/albums_screen.dart';
import 'package:banglabeats/presentation/songs_screen/songs_screen.dart';
import 'package:banglabeats/presentation/artists_tab_container_screen/artists_tab_container_screen.dart';
import 'package:banglabeats/presentation/subscribe_screen/subscribe_screen.dart';
import 'package:banglabeats/presentation/payment_method_screen/payment_method_screen.dart';
import 'package:banglabeats/presentation/add_new_card_screen/add_new_card_screen.dart';
import 'package:banglabeats/presentation/select_payment_method_screen/select_payment_method_screen.dart';
import 'package:banglabeats/presentation/payment_summary_screen/payment_summary_screen.dart';
import 'package:banglabeats/presentation/profile_details_one_screen/profile_details_one_screen.dart';
import 'package:banglabeats/presentation/edit_profile_screen/edit_profile_screen.dart';
import 'package:banglabeats/presentation/notification_settings_screen/notification_settings_screen.dart';
import 'package:banglabeats/presentation/audio_video_screen/audio_video_screen.dart';
import 'package:banglabeats/presentation/playback_screen/playback_screen.dart';
import 'package:banglabeats/presentation/data_saver_storage_screen/data_saver_storage_screen.dart';
import 'package:banglabeats/presentation/security_screen/security_screen.dart';
import 'package:banglabeats/presentation/language_screen/language_screen.dart';
import 'package:banglabeats/presentation/app_navigation_screen/app_navigation_screen.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    queueTabContainerScreen: (context) => QueueTabContainerScreen(),
